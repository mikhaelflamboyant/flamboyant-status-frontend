  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {costs.length > 0 && (
        <div className="flex flex-col gap-2">
          {costs.map((c, index) => (
            <div key={index} className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-2 bg-white">
              <div className="flex items-center gap-4 flex-1 flex-wrap">
                ...
                <span className="text-xs text-gray-500">
                  Planejado: <span className="font-medium text-gray-800">
                    R$ {displayValue(c.budget_planned)}
                  </span>
                </span>
                {c.budget_actual && (
                  <>
              ...
              <button type="button" onClick={() => handleRemove(index)} className="hover:opacity-70 transition-opacity shrink-0 ml-2">
                <TrashIcon />
              </button>
            </div>
          ))}
