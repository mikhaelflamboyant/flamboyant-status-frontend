...
const AREAS = [
  ...
  'Marketing Institucional','Marketing Urbanismo','Pessoas e Cultura',
  'Planejamento Financeiro','Processos','Projetos Executivos','Relacionamento',
  'Segurança','Suprimentos','Tecnologia da Informação','Vendas',
]
