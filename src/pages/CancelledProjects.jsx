...
export default function CancelledProjects() {
  ...
  const fetchProjects = (filtro = '') => {
    ...
    projectsService.listCancelled(params).then(r => {
      ...
      setError('Erro ao carregar projetos cancelados.')
      setLoading(false)
    })
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-base font-medium text-gray-900">Projetos cancelados</h1>
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-16">
            <p className="text-sm text-gray-400">Nenhum projeto cancelado encontrado.</p>
          </div>
        )}
